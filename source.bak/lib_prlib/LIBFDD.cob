...
001940       03  DATE-HTKC     PIC  9(001).                              地区
001950       03  DATE-HTNC     PIC  9(001).                              担当
001960       03  F             PIC  9(001).
001970     02  DATE-HM.                                                 品名
001980       03  DATE-HBC1     PIC  9(001).                              分類1
001990       03  DATE-HBC2     PIC  9(001).                              分類2
002000       03  DATE-HBC3     PIC  9(001).                              分類3
002010       03  F             PIC  9(001).
002020*
002030     02  F               PIC  X(012).                             I.970902
002040*****02  F               PIC  X(028).                             D.970902
002050*****02  F               PIC  X(052).                             D.970303
002060*****02  F               PIC  X(036).                             D.970409
002070     02  DATE-WC.                                                 和暦C
002080       03  DATE-WC1.                                              平成年
002090         04  DATE-YF1    PIC  9(002).                             開始年
002100         04  DATE-YT1    PIC  9(002).                             終了年
002110         04  DATE-YC1    PIC  9(004).                             +1988
002120       03  DATE-WC2.                                              昭和年
002130         04  DATE-YF2    PIC  9(002).                             開始年
002140         04  DATE-YT2    PIC  9(002).                             終了年
002150         04  DATE-YC2    PIC  9(004).                             +1925
002160*
002170     02  DATE-SC.                                                 西暦C
002180       03  DATE-SC1.                                              1900年
002190         04  DATE-NF1    PIC  9(002).                             開始年
002200         04  DATE-NT1    PIC  9(002).                             終了年
002210         04  DATE-NC1    PIC  9(004).                             +1900
002220       03  DATE-SC2.                                              2000年
002230         04  DATE-NF2    PIC  9(002).                             開始年
002240         04  DATE-NT2    PIC  9(002).                             終了年
002250         04  DATE-NC2    PIC  9(004).                             +2000
002260*
