...
000170       03  KKB-BC2  REDEFINES KKB-BC.
000180         04  KKB-KS1    PIC  9(001).                              ã@éÌÇP
000190         04  F          PIC  X(004).
000200       03  KKB-BC3  REDEFINES KKB-BC.
000210         04  KKB-SNO    PIC  X(005).                              édì¸êÊ
...
000280       03  KKB-BC6  REDEFINES KKB-BC.
000290         04  KKB-SGC    PIC  9(002).                              çÏã∆áÇ
000300         04  F          PIC  X(003).
000310       03  KKB-BC7  REDEFINES KKB-BC.
000320         04  KKB-JSC    PIC  9(001).                              édì¸êÊáÇ
000330         04  F          PIC  X(004).
000340       03  KKB-BC8  REDEFINES KKB-BC.                             ïsó«ó¶ëº
000350         04  F          PIC  X(005).                              I.961014
...
000420     02  KKB-NAME2  REDEFINES KKB-NAME1.
000430       03  KKB-KSN1     PIC  X(006).                              ã@éÌÇP
000440*****  03  F            PIC  X(051).                              D.960314
000450       03  KKB-KSS      PIC  9(002).                              I.960314
000460*****  03  F            PIC  X(049).                              D.961014
000470       03  KKB-YSR      PIC  9(001)V9(02).                        I.961014
000480       03  F            PIC  X(046).                              I.961014
000490     02  KKB-NAME3  REDEFINES KKB-NAME1.
000500       03  KKB-SNN      PIC  N(008).                              édì¸êÊ
000510       03  F            PIC  X(041).
...
000580     02  KKB-NAME6  REDEFINES KKB-NAME1.
000590       03  KKB-SGN      PIC  N(008).                              çÏã∆ñº
000600       03  F            PIC  X(041).
...
000660     02  KKB-NAME8  REDEFINES KKB-NAME1.                          I.961014
000670       03  KKB-FRR      PIC  9(001)V9(02).                        ïsó«ó¶
000680       03  F            PIC  X(054).                              I.961118
...
000950       03  KKB-DNO      PIC  X(006).                              ì`ï[áÇ
000960       03  KKB-DNOD   REDEFINES KKB-DNO.
000970         04  KKB-DNO1   PIC  X(001).
000980         04  KKB-DNO2   PIC  9(005).
000990       03  F            PIC  X(051).
