...
000050     VALUE      OF           IDENTIFICATION      "TEGATA-WK".
000060 01  TM-REC.
000070     02  TM-KEY          PIC X(8).
000080     02  BANKCD          PIC 9(4).
...
000210     02  FURNMN  REDEFINES  FURNM     PIC N(10).
000220     02  FURBNK          PIC X(20).
000230     02  FURBNKN  REDEFINES  FURBNK   PIC N(10).
000240     02  FILLER          PIC X(08).
