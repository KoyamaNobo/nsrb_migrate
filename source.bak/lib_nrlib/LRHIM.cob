...
000540*    [   êªë¢å¥âø   ]
000550*****02  HI-ZRG         PIC  9(005).                              D.090121
000560*****02  HI-SKG         PIC  9(005).                              D.090121
000570*****02  HI-GKG         PIC  9(005).                              D.090121
000580*****02  HI-KNG         PIC  9(004).                              D.090121
000590     02  F              PIC  X(019).                              I.090121
000600     02  HI-KT          PIC  9(005).
000610*
000620     02  HI-TCD         PIC  9(004).
000630     02  HI-ISU         PIC  9(003).
000640     02  HI-KRC         PIC  9(001).
000650     02  HI-SCC         PIC  9(001).
000660     02  HI-BMC         PIC  9(002).
000670     02  HI-BMNO        PIC  9(001).
000680     02  HI-YG          PIC  9(005).
000690     02  HI-HKB         PIC  9(001).
000700     02  HI-HPV         PIC  9(001).                              I.090121
000710     02  HI-BC4         PIC  9(001).                              I.090121
000720     02  F              PIC  X(011).                              I.090121
000730*****02  F              PIC  X(045).                              D.090121
000740*
000750     02  HI-SMS         PIC  N(016).                              I.090121
000760     02  HI-UNG         PIC  9(006).
000770     02  HI-NNG         PIC  9(006).
000780     02  HI-OL          PIC  X(001).
000790     02  HI-CS          PIC  N(010).
000800     02  F              PIC  X(006).
000810     02  HI-DNG         PIC  9(006).
000820     02  HI-SNG         PIC  9(004).                              ìoò^ì˙ït
000830     02  HI-SNGD    REDEFINES HI-SNG.
000840       03  HI-SNEN      PIC  9(002).
000850       03  HI-SGET      PIC  9(002).
000860     02  HI-ENG         PIC  9(004).                              îpé~ì˙ït
000870     02  HI-ENGD    REDEFINES HI-ENG.
000880       03  HI-ENEN      PIC  9(002).
000890       03  HI-EGET      PIC  9(002).
