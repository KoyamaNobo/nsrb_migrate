...
<div class="fblock">
	<div class="leftBlock">
		...
		<div>
			...
			<input id="modal-open" class="modal-open" type="button" value="<?php if(property_exists($oProcs,'procArray')){ echo (int)($oProcs->getCountProcArray()).'画面'; }else{ echo 'X画面'; } ?>" />
		</div>
	</div>
	<div class="rightBlock">
...
?>
	...
	<div id="modal">
		<div id="modalBody" class="modal-content">
			<div id="modalHeader">実行中</div>
			<div id="modalDetail"><?php
		//実行中のメニュー名を表示
