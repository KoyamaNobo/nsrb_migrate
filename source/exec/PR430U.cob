      ...
      *DISP-INIT
       CALL "SD_Init" USING
            "DISP-INIT" " " "0" "0" "47" " " " " RETURNING RESU.
       CALL "SD_Init" USING
            "01DISP-INIT" " " "1" "0" "30" " " "DISP-INIT"
            RETURNING RESU.
       CALL "SD_Init" USING
      ...
      *DISP-BUZZER
       ...
       CALL "SD_Init" USING
            "DISP-BUZ-J-04" "X" "24" "80" "5"
           "DISP-BUZ-J-02" " " RETURNING RESU.
       CALL "SD_Init" USING
            "DISP-BUZ-J-09" "X" "24" "80" "5"
           "DISP-BUZ-J-04" " " RETURNING RESU.
      *DSP-AREA
       CALL "SD_Init" USING
            "DSP-AREA" " " "0" "0" "94" " " " " RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-010" " " "24" "0" "94" " " "DSP-AREA" RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_From" USING
           "DSP-016" BY REFERENCE PLKEY(1) "3" "1"
           BY REFERENCE I 4 RETURNING RESU.
      *ACP-AREA
       CALL "SD_Init" USING
            "ACP-AREA" " " "0" "0" "4" " " " " RETURNING RESU.
       CALL "SD_Init" USING
            "ACP-010" " " "24" "0" "4" " " "ACP-AREA" RETURNING RESU.
       CALL "SD_Init" USING
