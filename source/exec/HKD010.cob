      ...
      *
       ...
       01  C-DSP.
           ...
           02  D-AD.
             03  FILLER  PIC ZZZ,ZZZ,ZZ9- .
             03  FILLER  PIC Z,ZZZ,ZZ9- .
             03  FILLER  PIC ZZZ,ZZZ,ZZ9- .
      ...
      *C-ACP
       CALL "SD_Init" USING 
            "C-ACP" " " "0" "0" "47" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
            "A-ACT" "9" "3" "43" "1" " " "C-ACP" RETURNING RESU.
       CALL "SD_Using" USING 
            "A-ACT" BY REFERENCE W-ACT "1" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-DNO" "9" "6" "17" "6" "A-ACT" " " RETURNING RESU.
       CALL "SD_Using" USING 
       ...
       CALL "SD_Init" USING 
            "05C-ACP" " " "W-L" "0" "21" "A-TCD" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "A-NC" "9" "W-L" "8" "2" " " "05C-ACP" RETURNING RESU.
       CALL "SD_Using" USING 
            "A-NC" BY REFERENCE W-NC "2" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-NSC" "9" "W-L" "24" "1" "A-NC" " " RETURNING RESU.
       CALL "SD_Using" USING 
            "A-NSC" BY REFERENCE W-NSC "1" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-TD" "9" "W-L" "25" "6" "A-NSC" " " RETURNING RESU.
       CALL "SD_Using" USING 
            "A-TD" BY REFERENCE W-TNGPS "6" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-KIN" "S9" "W-L" "39" "8" "A-TD" " " RETURNING RESU.
       CALL "SD_Using" USING 
            "A-KIN" BY REFERENCE W-KIN "8" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-SS" "9" "W-L" "51" "4" "A-KIN" " " RETURNING RESU.
       CALL "SD_Using" USING 
            "A-SS" BY REFERENCE W-SNGS "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-SKD" "9" "20" "15" "8" "05C-ACP" " " RETURNING RESU.
       CALL "SD_Using" USING 
      ...
      *C-DSP
       ...
       CALL "SD_Init" USING 
            "D-NCN" " " "W-L" "22" "13" " " "02C-DSP" RETURNING RESU.
       CALL "SD_Init" USING 
            "01D-NCN" "X" "W-L" "10" "1" " " "D-NCN" RETURNING RESU.
       CALL "SD_From" USING 
            "01D-NCN" BY REFERENCE W-NCN1 "1" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "02D-NCN" "N" "W-L" "11" "12" "01D-NCN" " " RETURNING RESU.
       CALL "SD_From" USING 
            "02D-NCN" BY REFERENCE HKB-NKNA "12" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-NSNA" "N" "W-L" "26" "12" "D-NCN" " " RETURNING RESU.
       CALL "SD_From" USING 
            "D-NSNA" BY REFERENCE HKB-NKNA "12" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-KIN" "ZZZZZZZ9-" "W-L" "39" "9" "D-NSNA" " "
            RETURNING RESU.
       CALL "SD_From" USING 
            "D-KIN" BY REFERENCE W-KIN "8" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-AD" " " "0" "0" "34" "02C-DSP" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01D-AD" "ZZZ,ZZZ,ZZ9-" "19" "36" "12" " " "D-AD"
            RETURNING RESU.
       CALL "SD_From" USING 
       ...
       CALL "SD_Init" USING 
            "D-SPACE" " " "0" "0" "62" "D-PRN" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01D-SPACE" " " "6" "22" "6" " " "D-SPACE" RETURNING RESU.
       CALL "SD_Init" USING 
            "S-DNO" "X" "6" "17" "6" " " "01D-SPACE" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-SPC" " " "W-L" "22" "48" "01D-SPACE" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "S-NCN" "X" "W-L" "8" "15" " " "D-SPC" RETURNING RESU.
       CALL "SD_Init" USING 
            "S-NSC" "X" "W-L" "24" "14" "S-NCN" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "S-TD" "X" "W-L" "25" "6" "S-NSC" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "S-KIN" "X" "W-L" "39" "9" "S-TD" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "S-SS" "X" "W-L" "51" "4" "S-KIN" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "03D-SPACE" " " "20" "22" "8" "D-SPC" " " RETURNING RESU.
       CALL "SD_Init" USING 
