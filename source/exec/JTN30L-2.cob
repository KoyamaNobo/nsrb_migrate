      ...
      *    JS-W     : 0=ñ{é– , 1=ëIë , 2=ì°ìc , 3=ëÅìá , 9=ï‘ïi       *
      ...
      *Initialize
       ...
       CALL "PR_Initialize" USING "999-JTN30L" RETURNING RESP.
      ...
      ******************************************************************
       ...
       HEAD-030.
           ...
           END-IF
           IF  JSTR-07       =  6
               MOVE  "ì˙êiÉSÉÄäîéÆâÔé–Å@ì°ìcîzëóÉZÉìÉ^Å[Å@"  TO
                                                            WORK-NAG
               MOVE  "701-0221"      TO  WORK-UNOG
               MOVE  "â™éRésìÏãÊì°ìcã—ÇTÇUÇSÅ|ÇPÇWÇXÅ@Å@Å@Å@Å@"  TO
                                                            WORK-JSG
               MOVE  "Å@Å@ì˙ñ{í â^áäâ™éRéxìXì°ìcëqå…ì‡" TO  WORK-JSSG
