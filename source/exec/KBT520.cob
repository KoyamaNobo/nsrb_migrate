       ...
       PROGRAM-ID. KBT520.
      **************************************************************
      *    PROGRAM         :  óöï®êªïiédì¸Å@édì¸êÊï î≠íçì¸å…écñ‚çáÇπ *
      *    PRINTER TYPE    :  JIPS                                 *
      *    SCREEN          :  SCBT52                               *
      *    COMPILE TYPE    :  COBOL                                *
      **************************************************************
      ...
      *C-ACP
       ...
       CALL "SD_Init" USING 
            "A-SCD" "9" "2" "8" "4" " " "C-ACP" RETURNING RESU.
       CALL "SD_Using" USING 
            "A-SCD" BY REFERENCE W-SCD "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-NO" "9" "19" "1" "2" "A-SCD" " " RETURNING RESU.
       CALL "SD_Using" USING 
      ...
      *C-DSP
       ...
       CALL "SD_Init" USING 
            "D-SNA" "N" "2" "13" "48" " " "C-DSP" RETURNING RESU.
       CALL "SD_From" USING 
            "D-SNA" BY REFERENCE S-NAME "48" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-MEI" " " "W-L" "0" "73" "D-SNA" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01D-MEI" "9" "W-L" "1" "2" " " "D-MEI" RETURNING RESU.
       CALL "SD_From" USING 
            "01D-MEI" BY REFERENCE W-G "2" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "02D-MEI" "9" "W-L" "4" "6" "01D-MEI" " " RETURNING RESU.
       CALL "SD_From" USING 
            "02D-MEI" BY REFERENCE HSH-HCD "6" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "03D-MEI" "N" "W-L" "11" "28" "02D-MEI" " " RETURNING RESU.
       CALL "SD_From" USING 
            "03D-MEI" BY REFERENCE HI-NAME "48" "0" RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            ...
            RETURNING RESU.
       CALL "SD_From" USING 
            "03D-GSD" BY REFERENCE W-GSU(1,1) "5" "2" 
            "3" 50 BY REFERENCE CNT 5 RETURNING RESU.
       CALL "SD_Init" USING 
            "04D-GSD" "------" "22" "W-C" "6" "03D-GSD" " "
            RETURNING RESU.
       CALL "SD_From" USING 
            "04D-GSD" BY REFERENCE W-GSU(1,1) "5" "2" 
            "4" 50 BY REFERENCE CNT 5 RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *
       M-05.
           CALL "SD_Screen_Output" USING "SCBT52" RETURNING RESU.
           MOVE ZERO TO W-DATA.
      ...
      *
           MOVE SPACE TO HSH-KEY3.
           MOVE W-SCD TO HSH-SCD.
      *           START HSHF KEY NOT < HSH-KEY3 INVALID KEY
      *///////////////
           CALL "DB_Start" USING
            HSHF_PNAME1 "HSH-KEY3" " NOT < " HSH-KEY3 RETURNING RET.
           IF  RET = 1
      ...
      *///////////////
           ...
           IF  RET = 1
               ...
               MOVE "Å@ÅñÅñÅñÅ@ïiñºÅ@Ç»ÇµÅ@ÅñÅñÅñ" TO HI-NAME
           END-IF
