       ...
       AUTHOR.                        E-SHIGIHARA.
      ***************************************************
      *    PROGRAM        : î[ä˙ïiñºï Å@éÛíçécÉäÉXÉg    *
      *    DATA WRITTEN   : 94/10/14                    *
      *    SCREEN USED    : UNUSED                      *
      *    FORM   USED    : UNUSED                      *
      *    PRINTER TYPE   : JIPS                        *
      *    COMPILE TYPE   : COBOL                       *
      ***************************************************
       ...
       01  HEAD2.
           ...
           02  FILLER                PIC X(08)  VALUE  "  ∫∞ƒﬁ  ".
           02  FILLER                PIC N(08)  VALUE
                 "ïiÅ@Å@Å@Å@Å@ñºÅ@".
           02  FILLER                PIC X(107)  VALUE  SPACE.
       01  HEAD3.
      ...
      *
       ...
       01  DSP-AREA.
           02  DSP-01.
               ...
               03  FILLER  PIC X(24) VALUE "î[ä˙ïiñºï Å@éÛíçécÉäÉXÉg".
           02  DSP-07.
