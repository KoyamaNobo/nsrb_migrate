      ...
      *FD  TMW
       01  TMW_HKD910.
           ...
           02  F              PIC  X(001).
           02  TMW_LNAME      PIC  X(010) VALUE "TMW_HKD910".
           02  F              PIC  X(001).
      ...
      *C-MID2
       ...
       CALL "SD_Init" USING 
            "06C-MID2" "X" "23" "40" "22" "05C-MID2" " " RETURNING RESU.
      *C-MID3
       CALL "SD_Init" USING 
            "C-MID3" " " "0" "0" "86" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01C-MID3" "N" "1" "20" "40" " " "C-MID3" RETURNING RESU.
       CALL "SD_Init" USING 
            "02C-MID3" "X" "8" "28" "24" "01C-MID3" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "03C-MID3" "X" "23" "40" "22" "02C-MID3" " " RETURNING RESU.
      *C-ACP
       CALL "SD_Init" USING 
       ...
       CALL "SD_Using" USING 
            ...
            147 RETURNING RESU.
       CALL "SD_Init" USING 
            "07C-ACP" " " "8" "0" "8" "A-NAME" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "A-STCD" "9" "8" "40" "4" " " "07C-ACP" RETURNING RESU.
       CALL "SD_Using" USING 
       ...
       CALL "SD_Init" USING 
            "A-DMM" "9" "23" "57" "1" "07C-ACP" " " RETURNING RESU.
       CALL "SD_Using" USING 
      ...
      *C-DSP
       ...
       CALL "SD_From" USING 
            "D-NAME" BY REFERENCE W-NAME(1) "52" "1" 
            BY REFERENCE W-C 147 RETURNING RESU.
       CALL "SD_Init" USING 
