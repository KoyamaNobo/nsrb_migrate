       ...
       PROGRAM-ID. JHS71L.
      *********************************************************
      *    PROGRAM         :  ìùàÍì`ï[çƒî≠çsÅiÉgÉâÉXÉRëºÅj    *
      *    PRINTER TYPE    :  JIPS                            *
      *    SCREEN          :  ******                          *
      *    COMPILE TYPE    :  COBOL                           *
      *********************************************************
      ...
      *FD  TDIF
       01  TDIF_JHS71L.
           02  TDIF_PNAME1    PIC  X(005) VALUE "TDIRF".
           02  F              PIC  X(001).
           02  TDIF_LNAME     PIC  X(011) VALUE "TDIF_JHS71L".
           02  F              PIC  X(001).
      ...
      *FD  WTNAF
       01  WTNAF_JHS71L.
           ...
           02  F              PIC  X(001).
           02  WTNAF_LNAME    PIC  X(012) VALUE "WTNAF_JHS71L".
           02  F              PIC  X(001).
      ...
      *
       ...
       01  C-MID.
           02  FILLER  PIC  N(015) VALUE
                "É`ÉFÅ[ÉìÉXÉgÉAìùàÍì`ï[Å@çƒî≠çs".
      ...
      *C-MID
       CALL "SD_Init" USING 
            "C-MID" " " "0" "0" "153" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01C-MID" "N" "1" "19" "30" " " "C-MID" RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "05C-MID" "N" "14" "33" "8" "04C-MID" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "06C-MID" "N" "15" "22" "8" "05C-MID" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "07C-MID" "N" "16" "22" "4" "06C-MID" " " RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *C-ACP
       ...
       CALL "SD_Init" USING 
            "A-SDNO" "9" "15" "34" "6" "A-TPC" " " RETURNING RESU.
       CALL "SD_Using" USING 
      ...
      *
           CALL "DB_F_Open" USING
            "INPUT" TDIF_PNAME1 " " BY REFERENCE TDIF_IDLST "0".
       M-10.
      *           READ TDIF AT END
      *///////////////
           CALL "DB_Read" USING
