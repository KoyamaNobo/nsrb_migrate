       ...
       INIT-RTN                    SECTION.
         INIT-000.
           ...
           CALL "DB_F_Open" USING
            "OUTPUT" BPLPRN_PNAME1 " " BY REFERENCE BPLPRN_IDLST "1"
            "BPLPRN-KEY" BY REFERENCE BPLPRN-KEY.
           CALL "DB_F_Close" USING
            BY REFERENCE BPLPRN_IDLST BPLPRN_PNAME1.
           CALL "DB_F_Open" USING
           ...
           CALL "DB_F_Open" USING "INPUT SEQUENTIAL" BU-F_PNAME1 
            "SHARED" BY REFERENCE BU-F_IDLST "1"
            "BU-KEY" BY REFERENCE BU-KEY.
           CALL "DB_F_Open" USING "INPUT" BNM_PNAME1 
            "SHARED" BY REFERENCE BNM_IDLST "1"
            "BNM-KEY" BY REFERENCE BNM-KEY.
           CALL "DB_F_Open" USING "INPUT" BPLHAI_PNAME1 
            "SHARED" BY REFERENCE BPLHAI_IDLST "1"
            "BPLHAI-KEY" BY REFERENCE BPLHAI-KEY.
           CALL "DB_F_Open" USING "INPUT" FCTL-F_PNAME1 
            "SHARED" BY REFERENCE FCTL-F_IDLST "1"
            "FCTL-KEY" BY REFERENCE FCTL-KEY.
           CALL "DB_F_Open" USING
            "I-O" BPLPRN_PNAME1 " " BY REFERENCE BPLPRN_IDLST "1"
            "BPLPRN-KEY" BY REFERENCE BPLPRN-KEY.
            CALL "DB_F_Open" USING
            "I-O" PL_PNAME1 "SHARED" BY REFERENCE PL_IDLST "1"
            "PL-KEY" BY REFERENCE PL-KEY.
      ...
      *///////////////
           CALL "DB_Read" USING
            "NEXT AT END" PL_PNAME1 BY REFERENCE PL-REC " "
            RETURNING RET.
           IF  RET = 1
               MOVE    1   TO      READ-FLG
               GO  TO  PLCLR-999
      ...
      *///////////////
       ...
       BUPL-READ-RTN               SECTION.
         BUPL-READ-000.
      *           READ    BU-F    UNLOCK   AT  END
      *//////////////////////
           CALL "DB_Read" USING
            "AT END" BU-F_PNAME1 BY REFERENCE BU-REC "UNLOCK"
            RETURNING RET.
           IF  RET = 1
               MOVE    2      TO   SYORI-FLG
      ...
      *           START   BPLPRN     KEY  NOT <  BPLPRN-KEY INVALID  KEY
      *///////////////
           CALL "DB_Start" USING
            BPLPRN_PNAME1 "BPLPRN-KEY" " NOT < " BPLPRN-KEY
            RETURNING RET.
           IF  RET = 1
       ...
       BPRN-SREAD-RTN              SECTION.
         BPRN-SREAD-000.
      *           READ    BPLPRN  NEXT    AT  END
      *///////////////
           CALL "DB_Read" USING
            "NEXT AT END" BPLPRN_PNAME1 BY REFERENCE BPLPRN-REC " "
            RETURNING RET.
           IF  RET = 1
               MOVE    3   TO  SYORI-FLG
           END-IF.
      ...
      *///////////////
           CALL "DB_Read" USING
            "INVALID KEY" PL_PNAME1 BY REFERENCE PL-REC " "
            RETURNING RET.
           IF  RET = 1
      ...
      *///////////////
       ...
       BPRN-RREAD-RTN              SECTION.
         BPRN-RREAD-000.
           MOVE     0         TO   READ-FLG.
           MOVE     BNM-PLPG (IX1) TO  BPLPRN-PG.
           MOVE     BU-LINNO       TO  BPLPRN-LNO.
      *           READ     BPLPRN    INVALID  KEY
      *///////////////
           CALL "DB_Read" USING
            "INVALID KEY" BPLPRN_PNAME1 BY REFERENCE BPLPRN-REC " "
            RETURNING RET.
           IF  RET = 1
               MOVE    1   TO  READ-FLG
           END-IF.
       ...
       BPRN-EDIT-RTN               SECTION.
         BPRN-EDIT-000.
           ...
           END-IF.
           MOVE    BNM-PLLN (IX1) TO  IX2.
           ADD     BU-TOGET    TO  BPLPRN-AM (IX2).
         BPRN-EDIT-999.
           EXIT.
      ...
      *///////////////
           CALL "DB_Insert" USING
            BPLPRN_PNAME1 BPLPRN_LNAME BPLPRN-REC RETURNING RET.
           IF  RET = 1
      ...
      *///////////////
       ...
       BNM-EDIT-RTN               SECTION.
         BNM-EDIT-000.
           ...
           MOVE    BPLPRN-PG   TO BPLHAI-PG.
           MOVE    IX1     TO  BPLHAI-LN.
      *           READ    BPLHAI  INVALID KEY
      *///////////////
           CALL "DB_Read" USING
            "INVALID KEY" BPLHAI_PNAME1 BY REFERENCE BPLHAI-REC " "
            RETURNING RET.
           IF  RET = 1
      ...
      *///////////////
           ...
           END-IF.
           IF  PL-TOUMM    NOT =   0
               COMPUTE ME1-AMTRT (IX1) ROUNDED =
                BPLPRN-AM (IX1) * 100    /   PL-TOUMM
           ELSE
