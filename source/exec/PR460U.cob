      ...
      *
       ...
       01  DSP-CLR-AREA.
           ...
           03  DSP-CLR-01     PIC  X(1)   VALUE  " ".
           03  DSP-CLR-02     PIC X(30)
                              VALUE  "                              ".
       01  DSP-AREA.
           03  DSP-010.
               05  FILLER  PIC  N(01)  VALUE  "”N".
               05  FILLER  PIC  N(02)  VALUE  "ŒŽ“x".
               05  FILLER  PIC  9(02).
               05  FILLER  PIC  9(02).
               05  DSP-011      PIC  X(26)
                    VALUE    " •”–å•Ê‘¹‰vŒvŽZ‘iŠú––j ".
           03  DSP-020.
               05  FILLER.
                   07  FILLER   PIC  N(04) VALUE  "‚e‚q‚n‚l".
                   07  FILLER   PIC  N(02) VALUE  "‚s‚n".
               05  FILLER.
                   07  FILLER   PIC  N(5)  VALUE  "•”–åƒR[ƒh".
                   07  FILLER   PIC  N(1)  VALUE  "`".
           03  DSP-030.
               05  DSP-031      PIC  N(2)  VALUE  "Šm”F".
               05  DSP-032      PIC  X(13) VALUE  "OK=1,NO=9 ( )".
       01  DSP-AREA2.
           03  DSP-050.
               05  DSP-051      PIC  X(14)
                                VALUE  "ºÝÄÛ°Ù DATE Å¼".
      ...
      *DSP-AREA
       ...
       CALL "SD_Init" USING
            "DSP-010" " " "1" "0" "36" " " "DSP-AREA"  RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_Init" USING
            "DSP-011" "RX" "1" "28" "26" "04DSP-010" " "
            RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-020" " " "0" "0" "24" "DSP-010" " "  RETURNING RESU.
       CALL "SD_Init" USING
            "01DSP-020" " " "4" "0" "12" " " "DSP-020"
            RETURNING RESU.
       CALL "SD_Init" USING
            "0101DSP-020" "N" "4" "27" "8" " " "01DSP-020"
            RETURNING RESU.
       CALL "SD_Init" USING
            "0201DSP-020" "N" "4" "49" "4" "0101DSP-020" " "
            RETURNING RESU.
       CALL "SD_Init" USING
            "02DSP-020" " " "6" "0" "12" "01DSP-020" " "
            RETURNING RESU.
       CALL "SD_Init" USING
            "0102DSP-020" "N" "6" "11" "10" " " "02DSP-020"
            RETURNING RESU.
       CALL "SD_Init" USING
            "0202DSP-020" "N" "6" "40" "2" "0102DSP-020" " "
            RETURNING RESU.
       CALL "SD_Init" USING
      ...
      *DSP-AREA2
       ...
       CALL "SD_Init" USING 
            "DSP-051" "X" "24" "1" "14" " " "DSP-050" RETURNING RESU.
       CALL "SD_Init" USING 
            "DSP-052" "X" "24" "1" "13" "DSP-051" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "DSP-053" "X" "24" "1" "15" "DSP-052" " " RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *///////////////
           ...
           IF  RET = 1
               CALL "SD_Output" USING "DSP-051" DSP-051 "p"
                                                 RETURNING RESU
               CALL "SD_Output" USING "DISP-BUZ-J-03" DISP-BUZ-J-03
                                           "p" RETURNING RESU
           ...
           IF  ZI > 15
               ...
               CALL "SD_Output" USING "INV-CON" INV-CON "p"
                                                 RETURNING RESU
               CALL "SD_Output" USING "DISP-BUZ-B" DISP-BUZ-B
                                           "p" RETURNING RESU
               CALL "DB_F_Close" USING
                BY REFERENCE FCTL-F_IDLST FCTL-F_PNAME1
               CALL "DB_Close"
      ...
      *
           ...
           CALL "SD_Output" USING "DSP-010" DSP-010 "p" RETURNING RESU.
           CALL "SD_Output" USING "DSP-020" DSP-020 "p" RETURNING RESU.
           CALL "SD_Output" USING "DSP-030" DSP-030 "p" RETURNING RESU.
      *
       ST-10.
      ...
      *****
       CHK-RTN.
           ...
           CALL "SD_Output" USING "DSP-CLR-01" DSP-CLR-01 "p"
                                                     RETURNING RESU.
           CALL "SD_Output" USING "DSP-CLR-02" DSP-CLR-02 "p"
                                                     RETURNING RESU.
           CALL "C3_Set_Jrcode" USING 
            USER_ID BY REFERENCE COMPLETION_CODE  255.
       CHK-RTNEX.
