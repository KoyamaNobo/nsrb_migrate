      ...
      *********************************************************
       ...
       01  NSSW-F_HMY660.
           ...
           02  F              PIC  X(001).
           02  NSSW-F_LNAME   PIC  X(013)  VALUE "NSSW-F_HMY660".
           02  F              PIC  X(001).
      ...
      *C-MID
       ...
       CALL "SD_Init" USING
            "16C-MID" " " "6" "0" "19" "02C-MID" " " RETURNING RESU.
       CALL "SD_Init" USING
            "17C-HCM" "N" "6" "20" "4" " " "16C-MID" RETURNING RESU.
       CALL "SD_Init" USING
            "18C-HCM" "X" "6" "24" "4" "17C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "19C-HCM" "N" "6" "37" "2" "18C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "20C-HCM" "N" "6" "50" "4" "19C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "21C-HCM" "X" "6" "54" "5" "20C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "22C-HCM" "N" "7" "37" "2" "16C-MID" " " RETURNING RESU.
       CALL "SD_Init" USING
            "23C-HCM" "N" "8" "37" "2" "22C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "24C-HCM" "N" "9" "37" "2" "23C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "25C-HCM" " " "10" "0" "16" "24C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "26C-HCM" "N" "10" "37" "2" " " "25C-HCM" RETURNING RESU.
       CALL "SD_Init" USING
            "27C-HCM" "N" "10" "50" "8" "26C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "28C-HCM" "X" "10" "58" "6" "28C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "29C-HCM" "N" "11" "37" "2" "25C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "30C-HCM" "N" "12" "37" "2" "29C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "31C-HCM" "N" "13" "37" "2" "30C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "32C-HCM" "N" "14" "37" "2" "31C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "33C-HCM" "N" "15" "37" "2" "32C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "34C-HCM" "N" "16" "37" "2" "33C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "35C-HCM" "N" "17" "37" "2" "34C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "36C-HCM" "N" "18" "37" "2" "35C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "37C-HCM" "N" "19" "37" "2" "36C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "38C-HCM" "N" "20" "37" "2" "37C-HCM" " " RETURNING RESU.
       CALL "SD_Init" USING
            "39C-HCM" "X" "23" "37" "22" "38C-HCM" " " RETURNING RESU.
      *C-ACP
       CALL "SD_Init" USING
       ...
       CALL "SD_Using" USING
            "A-HCDF" BY REFERENCE W-HCDF(1) "6" "0" BY REFERENCE CNT 31
             RETURNING RESU.
       CALL "SD_Init" USING
            "A-HCDT" "9" "W-L" "40" "6" "A-HCDF" " " RETURNING RESU.
       CALL "SD_Using" USING
            "A-HCDT" BY REFERENCE W-HCDT(1) "6" "0" BY REFERENCE CNT 31
             RETURNING RESU.
       CALL "SD_Init" USING
