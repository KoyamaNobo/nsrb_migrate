      ...
      *
       ...
       01  DSP-AREA.
           03  DSP-010.
               ...
               05  FILLER      PIC  9(02).
               05  FILLER      PIC  9(02).
               05  DSP-011     PIC  X(26)  VALUE
                                     " •”–å•Ê‘¹‰vŒvŽZ‘iŒŽŽŸj ".
           03  DSP-020.
               05  FILLER      PIC  N(04) VALUE   "‚e‚q‚n‚l".
               05  FILLER      PIC  N(02) VALUE   "‚s‚n".
               05  FILLER      PIC  N(05) VALUE  "•”–åƒR[ƒh".
      ...
      *****
       CLSE-ENT.
           ...
           CALL "DB_F_Close" USING
            BY REFERENCE FCTL-F_IDLST BU-F_PNAME1.
       CLSE-EXT.
           EXIT.
      ***
       COPY  LPMSG_PR.
