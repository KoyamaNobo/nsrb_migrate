      ...
      *FD  JSSRYR
       01  JSSRYR_KBY300.
           ...
           02  F              PIC  X(001).
           02  JSSRYR_LNAME   PIC  X(013) VALUE "JSSRYR_KBY300".
           02  F              PIC  X(001).
      ...
      *C-MID
       ...
       CALL "SD_Init" USING 
            "10C-MID" "X" "18" "22" "24" "09C-MID" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "11C-MID" "X" "22" "23" "22" "10C-MID" " " RETURNING RESU.
      *C-ACP
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "A-SSCD" "9" "18" "34" "4" " " "02C-ACP" RETURNING RESU.
       CALL "SD_Using" USING 
            "A-SSCD" BY REFERENCE W-SSCD "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-ESCD" "9" "18" "42" "4" "A-SSCD" " " RETURNING RESU.
       CALL "SD_Using" USING 
            "A-ESCD" BY REFERENCE W-ESCD "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "A-DMM" "9" "22" "40" "1" "02C-ACP" " " RETURNING RESU.
       CALL "SD_Using" USING 
