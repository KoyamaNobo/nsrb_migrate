      ...
      *FD  HFTSF
       01  HFTSF_HMM750.
           ...
           02  F              PIC  X(001).
           02  HFTSF_LNAME    PIC  X(012) VALUE "HFTSF_HMM750".
           02  F              PIC  X(001).
      ...
      *FD  STRANYR
       01  STRANYR_HMM750.
           ...
           02  F              PIC  X(001).
           02  STRANYR_LNAME  PIC  X(014) VALUE "STRANYR_HMM750".
           02  F              PIC  X(001).
      ...
      *FD  RSTRANYR
       01  RSTRANYR_HMM750.
           ...
           02  F               PIC  X(001).
           02  RSTRANYR_LNAME  PIC  X(015) VALUE "RSTRANYR_HMM750".
           02  F               PIC  X(001).
      ...
      *FD  SNTRF
       01  SNTRF_HMM750.
           ...
           02  F              PIC  X(001).
           02  SNTRF_LNAME    PIC  X(012) VALUE "SNTRF_HMM750".
           02  F              PIC  X(001).
      ...
      *FD  UTRF
       01  UTRF_HMM750.
           ...
           02  F              PIC  X(001).
           02  UTRF_LNAME     PIC  X(011) VALUE "UTRF_HMM750".
           02  F              PIC  X(001).
      ...
      *FD  UTRYR
       01  UTRYR_HMM750.
           ...
           02  F              PIC  X(001).
           02  UTRYR_LNAME    PIC  X(012) VALUE "UTRYR_HMM750".
           02  F              PIC  X(001).
      ...
      *FD  STRAN
       01  STRAN_HMM750.
           ...
           02  F              PIC  X(001).
           02  STRAN_LNAME    PIC  X(012) VALUE "STRAN_HMM750".
           02  F              PIC  X(001).
      ...
      *FD  UTRAN
       01  UTRAN_HMM750.
           ...
           02  F              PIC  X(001).
           02  UTRAN_LNAME    PIC  X(012) VALUE "UTRAN_HMM750".
           02  F              PIC  X(001).
      ...
      *///////////////
           ...
           IF  SNTR-DC = 1 OR 5
               COMPUTE HUH-UG = HUH-UG - (SNTR-SU * SNTR-FT * -1)
                                       + (SNTR-SU * HFTS-FT * -1)
               COMPUTE HUH-YK = HUH-YK + (SNTR-SU * SNTR-FT * -1)
                                       - (SNTR-SU * HFTS-FT * -1)
           ELSE
               COMPUTE HUH-UG = HUH-UG - (SNTR-SU * SNTR-FT)
                                       + (SNTR-SU * HFTS-FT)
               COMPUTE HUH-YK = HUH-YK + (SNTR-SU * SNTR-FT)
                                       - (SNTR-SU * HFTS-FT)
           END-IF
      ...
      *///////////////
           CALL "DB_Select" USING
            RSTRANYR_PNAME1 "WHERE" 
            "RSTRANY-NG" "=" W-NG "AND"
            "RSTRANY-UNC" "NOT =" "1" RETURNING RET.
       M-42.
      ...
      *///////////////
           ...
           COMPUTE HUH-YK = HUH-YK - UTR-KIN + (UTR-SU * HFTS-FT).
      *           REWRITE HUH-R INVALID KEY
      *///////////////
           CALL "DB_Update" USING
            HUH-M_PNAME1 HUH-M_LNAME HUH-R RETURNING RET.
      ...
      *///////////////
       ...
       M-90.
           ...
           IF  JS-SIGN = 2
               ...
               CALL "DB_F_Close" USING
                BY REFERENCE UTRF_IDLST UTRF_PNAME1
           END-IF.
       M-95.
           CALL "SD_Output" USING "C-CLEAR" C-CLEAR "p" RETURNING RESU.
           CALL "DB_Close".
