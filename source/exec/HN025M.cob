      ...
      *C-ACP
       ...
       CALL "SD_Init" USING 
            "02C-ACP" " " "5" "0" "10" "A-SEN" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "A-TCD1" "9" "5" "8" "4" " " "02C-ACP" RETURNING RESU.
       CALL "SD_Using" USING 
       ...
       CALL "SD_Init" USING 
            "03C-ACP" " " "8" "0" "10" "02C-ACP" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "A-TCD2" "9" "8" "4" "4" " " "03C-ACP" RETURNING RESU.
       CALL "SD_Using" USING 
       ...
       CALL "SD_Init" USING 
            "A-DMM" "9" "23" "67" "1" "03C-ACP" " " RETURNING RESU.
       CALL "SD_Using" USING 
            "A-DMM" BY REFERENCE W-DMM "1" "0" RETURNING RESU.
      *C-DSP
       CALL "SD_Init" USING 
            "C-DSP" " " "0" "0" "374" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
            "D-MEC" " " "0" "0" "20" " " "C-DSP" RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "0101D-ME1" "X" "5" "12" "2" " " "01D-ME1" RETURNING RESU.
       CALL "SD_Init" USING 
            "0201D-ME1" "N" "5" "15" "6" "0101D-ME1" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "02D-ME1" "N" "7" "10" "14" "01D-ME1" " " RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "04C-DSP" " " "5" "0" "100" "D-ME2" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "D-TNA" "N" "5" "22" "52" " " "04C-DSP" RETURNING RESU.
       CALL "SD_From" USING 
       ...
       CALL "SD_Init" USING 
            "05C-DSP" " " "W-L" "0" "212" "04C-DSP" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "D-MEIH" " " "W-L" "0" "65" " " "05C-DSP" RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "05D-MEIH" "Z" "W-L" "74" "5" "04D-MEIH" " " RETURNING RESU.
       CALL "SD_From" USING 
            "05D-MEIH" BY REFERENCE THT-TT "5" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-MEIT" " " "W-L" "0" "67" "D-MEIH" " " RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "05D-MEIT" "Z" "W-L" "74" "5" "04D-MEIT" " " RETURNING RESU.
       CALL "SD_From" USING 
            "05D-MEIT" BY REFERENCE THT-TT "5" "0" RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *C-ERR
       ...
       CALL "SD_Init" USING 
            "E-ME9" "N" "24" "15" "16" "E-ME3" " " RETURNING RESU.
      *
           COPY LSSEM_P.
      *
