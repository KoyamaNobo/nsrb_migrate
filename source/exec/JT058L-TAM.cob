      ...
      **        JS-SIGN    : 0=ñ{é– , 1=ëIë , 2=ã ìá , 3=ëÅìá **
      ...
      *
           ...
           AND  (OKJF-05      <  4056000  OR      >  4057999)
             IF    OKJF-04      =  6
                 MOVE  "â™éRåßëqï~ésã ìáâ≥ìáéöêVñ©Å@Å@Å@" TO   R2-JS
             ELSE
                 IF    OKJF-04      =  4
      ...
      *
           ...
           AND  (OKJF-05      <  4056000  OR      >  4057999)
             ...
             ELSE
                 IF  OKJF-04      =  6
                     MOVE  "Å@Å@Å@Å@Å@Å@Å@Å@Å@ÇWÇQÇUÇQÅ|ÇPÅ@" TO   R2-JS
                 ELSE
                     IF  OKJF-04      =  4
           ...
           ELSE
               ...
               ELSE
                   ...
                   MOVE  "Å@Å@Å@Å@î¸çÁí¨å¥ìcÇRÇQÇQÇVÅ|ÇPÅ@"   TO  R2-JS
                           ELSE
                               IF  OKJF-04      =  6
                   MOVE  "Å@Å@Å@êÖìáç`çëç€ï®ó¨ÉZÉìÉ^Å[ì‡Å@"   TO  R2-JS
                               ELSE
               ...
               ELSE
                   ...
                   ELSE
                     ...
                     MOVE  "ì˙êiÉSÉÄáäÅ@í√éRï®ó¨ÉZÉìÉ^Å["   TO  R3-NA
                             ELSE
                                 IF  OKJF-04      =  6
                     MOVE  "ì˙êiÉSÉÄáäÅ@ã ìáï®ó¨ÉZÉìÉ^Å["   TO  R3-NA
                                 ELSE
