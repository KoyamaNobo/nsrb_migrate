      ...
      *01  DSP-CLR-AREA
       ...
       CALL "SD_Init" USING 
            "DSP-CLR-01" "X" "23" "1" "1" "DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *01  DSP-AREA
       ...
       CALL "SD_Init" USING 
            "02DSP-010" "N" "1" "8" "4" "01DSP-010" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "03DSP-010" "9" "1" "2" "2" "02DSP-010" " " RETURNING RESU.
       CALL "SD_From" USING 
            "03DSP-010" BY REFERENCE Z-GEMYY2 "2" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "04DSP-010" "9" "1" "6" "2" "03DSP-010" " " RETURNING RESU.
       CALL "SD_From" USING 
            "04DSP-010" BY REFERENCE Z-GEMMM "2" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "DSP-011" "RX" "1" "28" "30" "04DSP-010" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "DSP-020" " " "0" "0" "24" "DSP-010" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01DSP-020" " " "4" "0" "12" " " "DSP-020" RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "DSP-032" "X" "24" "66" "13" "DSP-031" " " RETURNING RESU.
      *01  DSP-AREA2
       CALL "SD_Init" USING 
       ...
       CALL "SD_From" USING 
            "D59-2" BY REFERENCE GNKEY(1) "3" "1" BY REFERENCE I 4
            RETURNING RESU.
      *01  DSP-SP
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "0101DSP-SP" "X" "6" "29" "4" " " "01DSP-SP" RETURNING RESU.
       CALL "SD_Init" USING 
            "0201DSP-SP" "X" "6" "49" "4" "0101DSP-SP" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "02DSP-SP" " " "24" "0" "1" "01DSP-SP" " " RETURNING RESU.
       CALL "SD_Init" USING 
