      ...
      *       01  DSP-INI.
       ...
       CALL "SD_Init" USING
            ...
            RETURNING RESU.
       CALL "SD_From" USING
            "0101DSP-INI" BY REFERENCE Z-GEMYY2 "2" "0"
                                              RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_Init" USING
            ...
            RETURNING RESU.
       CALL "SD_From" USING
            "0301DSP-INI" BY REFERENCE Z-GEMMM "2" "0"
                                             RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_Init" USING
            ...
            RETURNING RESU.
       CALL "SD_From" USING
            "0501DSP-INI" BY REFERENCE WKSP "26" "0"
                                         RETURNING RESU.
       CALL "SD_Init" USING
      ...
      *///////////////
           CALL "DB_Read" USING
            ...
            RETURNING RET.
           IF  RET = 1
               PERFORM   ERR5-000 THRU ERR5-999
           END-IF.
       RAN2-999.
           EXIT.
       KOS6-000.
      ...
      *///////////////
       ...
       EDIT6-002.
           ...
           PERFORM  RUIKEI-000 THRU RUIKEI-999.
           ADD   HH-KIL   TO   BKHPRN-GI(SOJI1).
       EDIT6-999.
           EXIT.
       SYU6-000.
           IF  W-FLG2  NOT  =   1
