      ...
      *
           ...
           02  P-R6   REDEFINES P-R1.
               ...
               03  R6-01               PIC     N(20).
               03  F                   PIC     X(88).
           02  P-R7   REDEFINES P-R1.
               03  F                   PIC     X(14).
               03  R7-01               PIC     N(14).
               03  F                   PIC     X(94).
           02  P-R8   REDEFINES P-R1.
               03  F                   PIC     X(39).
               03  R8-01               PIC     ZZ9.
               03  F                   PIC     X(07).
               03  R8-02               PIC     ZZ,ZZZ.
      ...
      *DISP-AREA1
       CALL "SD_Init" USING 
            "DISP-AREA1" " " "0" "0" "148" " " " "  RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            ...
            RETURNING RESU.
       CALL "SD_Init" USING 
            "05DISP-04A" "N" "9" "41" "6" "04DISP-04A" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "06DISP-04A" "X" "9" "47" "6" "05DISP-04A" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *ACT-AREA
       ...
       CALL "SD_Init" USING 
            "ACT-JS" "9" "9" "52" "1" "ACT-SOK" " "  RETURNING RESU.
       CALL "SD_Using" USING 
      ...
      *CLR-AREA
       ...
       CALL "SD_Init" USING 
            "CLR-JS" "X" "9" "52" "1" "CLR-01" " "  RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *
           MOVE  ALL "Ｎ"    TO        R4-01.
           MOVE       SPACE    TO        R4-02  R4-04.
           CALL "PR_LineFeed" USING "1" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
           MOVE       SPACE    TO        P-R.
      *
           MOVE  ALL "Ｎ"    TO        R4-01  R4-02.
           MOVE  ALL  "9"      TO        R4-03.
           MOVE       SPACE    TO        R4-04.
           CALL "PR_LineFeed" USING "1" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
      ...
      *
           ...
           MOVE       SPACE    TO        P-R.
      *
           MOVE       TC-UNO   TO        R15-01.
           CALL "PR_LineFeed" USING "2" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
           MOVE       SPACE    TO        P-R.
      *
           MOVE       TC-TEL   TO        R15-01.
           CALL "PR_LineFeed" USING "2" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
           MOVE       SPACE    TO        P-R.
      *
           MOVE       TC-JSU   TO        R2-01.
           MOVE  "地下・布靴・長靴・その他"  TO  R2-02.
           CALL "PR_LineFeed" USING "2" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
           MOVE       SPACE    TO        P-R.
      *
           MOVE       TC-JSS   TO        R2-01.
           MOVE       SPACE    TO        R2-02.
           CALL "PR_LineFeed" USING "1" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
           MOVE       SPACE    TO        P-R.
      ...
      *
           ...
           COPY LNAMP5.
           MOVE       WN-ONAME TO        R4-01.
           MOVE       SPACE    TO        R4-02  R4-04.
           CALL "PR_LineFeed" USING "1" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
           MOVE       SPACE    TO        P-R.
      *
           MOVE       WN-UNAME TO        R4-01.
           MOVE       SPACE    TO        R4-02  R4-04.
           MOVE       JCON3-03 TO        F2.
           MOVE       SOM      TO        R4-02.
           MOVE       OKJF-01  TO        R4-03.
           IF  ACT2         =  2
               MOVE   "再　"   TO   R4-04
           END-IF
           CALL "PR_LineFeed" USING "1" RETURNING RESP.
      ...
      *
           ...
           OR   (OKJF-05  NOT <  3966002  AND NOT >  3966999)
           OR   (OKJF-05  NOT <  3015001  AND NOT >  3015999)
           OR   (OKJF-04  NOT =  1)
               MOVE  "086-243-2456  " TO     R5-01
           END-IF
           IF   (OKJF-05  NOT <  2654000  AND NOT >  2654999)
           OR   (OKJF-05  NOT <  2656000  AND NOT >  2657999)
           OR   (OKJF-05  NOT <  4038000  AND NOT >  4038999)
      ...
      *
           IF   (OKJF-05  NOT <  2654000  AND NOT >  2654999)
           OR   (OKJF-05  NOT <  2656000  AND NOT >  2657999)
               MOVE  "520-2132      " TO     R5-00
               GO  TO  PRT-51
           END-IF
           IF   (OKJF-05  NOT <  4038000  AND NOT >  4038999)
             OR (OKJF-05  NOT <  4054000  AND NOT >  4054999)
             OR (OKJF-05  NOT <  4056000  AND NOT >  4057999)
               MOVE  "542-0081      " TO     R5-00
               GO  TO  PRT-51
           END-IF
           IF  (OKJF-05  NOT <  0459002  AND NOT >  0459999)
               MOVE  "663-8033      " TO     R5-00
           ELSE
               IF  OKJF-05  NOT <  0460002  AND NOT >  0460999
                   MOVE  "663-8033    "   TO     R5-00
               ELSE
                   IF  OKJF-05  NOT <  3966002  AND NOT >  3966999
                       MOVE  "165-0021    "   TO     R5-00
                   ELSE
                       IF  OKJF-05  NOT <  3015001  AND NOT >  3015999
                           MOVE  "114-0034    "   TO     R5-00
                       ELSE
                           IF  OKJF-04      =  6
                               MOVE  "701-0221    "   TO     R5-00
                           ELSE
                               IF  OKJF-04      =  7
                                   MOVE  "709-3717    "   TO     R5-00
                               ELSE
                                   IF  OKJF-04      =  4
                                   MOVE  "701-0304    "   TO     R5-00
                                   ELSE
                                   MOVE  "700-0975      " TO     R5-00
                                   END-IF
                               END-IF
                           END-IF
                       END-IF
      ...
      *
           IF   (OKJF-05  NOT <  2654000  AND NOT >  2654999)
           OR   (OKJF-05  NOT <  2656000  AND NOT >  2657999)
               MOVE  "077-543-1331  " TO     R5-00
               GO  TO  PRT-52
           END-IF
           IF   (OKJF-05  NOT <  4038000  AND NOT >  4038999)
             OR (OKJF-05  NOT <  4054000  AND NOT >  4054999)
             OR (OKJF-05  NOT <  4056000  AND NOT >  4057999)
               MOVE  "06-6268-4561  " TO     R5-00
               GO  TO  PRT-52
           END-IF
           IF   (OKJF-05  NOT <  0459002  AND NOT >  0459999)
               MOVE  "0798-64-5111  " TO     R5-00
           ELSE
               IF  OKJF-05  NOT <  0460002  AND NOT >  0460999
                   MOVE  "0798-67-0810"   TO     R5-00
               ELSE
                   IF  OKJF-05  NOT <  3966002  AND NOT >  3966999
                       MOVE  "03-5373-6711"   TO     R5-00
                   ELSE
                       IF  OKJF-05  NOT <  3015001  AND NOT >  3015999
                           MOVE  "03-3909-8883"   TO     R5-00
                       ELSE
                           MOVE  "086-243-2456  " TO     R5-00
                       END-IF
                   END-IF
               END-IF
           END-IF.
      ...
      *
           IF   (OKJF-05      <  0459002  OR      >  0459999)  AND
                ...
                (OKJF-05      <  4056000  OR      >  4057999)
                IF  OKJF-04      =  6
                MOVE  "岡山市南区藤田錦５６４－１８９　　　　　"   TO
                                                                 R6-01
                ELSE
                IF  OKJF-04      =  4
                MOVE  "岡山県都窪郡早島町早島４５０７－３７　　"   TO
                                                                 R6-01
                END-IF
                END-IF
           END-IF
      ...
      *
           IF   (OKJF-05  NOT <  2654000  AND NOT >  2654999)
           OR   (OKJF-05  NOT <  2656000  AND NOT >  2657999)
           MOVE "　　滋賀県大津市神領１－９－３　　　　　"  TO  R6-01
           ELSE
               IF   (OKJF-05  NOT <  4038000  AND NOT >  4038999)
                 OR   (OKJF-05  NOT <  4054000  AND NOT >  4054999)
                 OR   (OKJF-05  NOT <  4056000  AND NOT >  4057999)
           MOVE "　　大阪市中央区南船場１丁目１１－９　　"  TO  R6-01
               ELSE
                   IF   (OKJF-05  NOT <  0459002  AND NOT >  0459999)
                   OR   (OKJF-05  NOT <  0460002  AND NOT >  0460999)
           MOVE "　　兵庫県西宮市高木東町１５－１　　　　"  TO  R6-01
                   ELSE
                      IF   (OKJF-05  NOT <  3966002  AND NOT >  3966999)
           MOVE "　　東京都中野区丸山２－５－１９　　　　"  TO  R6-01
                      ELSE
                      IF   (OKJF-05  NOT <  3051001  AND NOT >  3015999)
           MOVE "　　東京都北区上十条４－１－５　　　　　"  TO  R6-01
                      ELSE
                          IF  OKJF-04      =  6
           MOVE "　　　　日本通運㈱岡山支店藤田倉庫内　　"  TO  R6-01
                          ELSE
                              IF  OKJF-04      =  7
           MOVE "岡山県久米郡美咲町原田３２２７－１　　　"  TO  R6-01
                              ELSE
                                  IF  OKJF-04      =  4
           MOVE "　　　　両備ＨＤ中四国物流センター内　　"  TO  R6-01
                                  ELSE
           MOVE "　　岡山市北区今８丁目１６番１７号　　　"  TO  R6-01
                                  END-IF
                              END-IF
                          END-IF
                      END-IF
      ...
      *
           IF   (OKJF-05  NOT <  2654000  AND NOT >  2654999)
           OR    OKJF-05  NOT <  2656000  AND NOT >  2657999
               MOVE     "株式会社新日本教育シューズ　"  TO  R7-01
           ELSE
               IF   (OKJF-05  NOT <  4038000  AND NOT >  4038999)
                 OR   (OKJF-05  NOT <  4054000  AND NOT >  4054999)
                 OR   (OKJF-05  NOT <  4056000  AND NOT >  4057999)
               MOVE     "　　千曲産業株式会社　　　　"  TO  R7-01
               ELSE
                   IF  OKJF-05  NOT <  0459002  AND NOT >  0459999
                      MOVE     "　　株式会社上山實業　　　　"  TO  R7-01
                   ELSE
                      IF  OKJF-05  NOT <  0460002  AND NOT >  0460999
                      MOVE     "　　株式会社ウエヤマ　　　　"  TO  R7-01
                      ELSE
                      IF  OKJF-05  NOT <  3966002  AND NOT >  3966999
                      MOVE     "　　多比良株式会社　　　　　"  TO  R7-01
                      ELSE
                      IF  OKJF-05  NOT <  3015001  AND NOT >  3015999
                      MOVE     "　　株式会社スギヤマ　　　　"  TO  R7-01
                      ELSE
                          IF  OKJF-04      =  6
                      MOVE     "日進ゴム㈱　藤田配送センター"  TO  R7-01
                          ELSE
                              IF  OKJF-04      =  7
                      MOVE     "日進ゴム㈱　津山物流センター"  TO  R7-01
                              ELSE
                                  IF  OKJF-04      =  4
                      MOVE     "日進ゴム　早島配送センター　"  TO  R7-01
                                  ELSE
                      MOVE     "　　日進ゴム株式会社　　　　"  TO  R7-01
                                  END-IF
                              END-IF
                          END-IF
                      END-IF
      ...
      *
           MOVE       W-20K    TO        R8-20K.
           MOVE       OKJF-07  TO        R8-01.
           COMPUTE  W-GR     =  OKJF-07      *   25.
           MOVE       W-GR     TO        R8-02.
           CALL "PR_LineFeed" USING "1" RETURNING RESP.
           CALL "PR_Write" USING P-R RETURNING RESP.
           MOVE       SPACE    TO        P-R.
