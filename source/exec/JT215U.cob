      ...
      ******************************************************************
      *    <<REMARKS>>                                                 *
      *    FUNCTION.......  î[ä˙ïiñºï Å@éÛíçécÉäÉXÉg                   *
      *    RELEASE DATE...  94/10/14         (REV.001)                 *
      ******************************************************************
      ...
      *DSP-MIDAS
       CALL "SD_Init" USING 
            "DSP-MIDAS" " " "0" "0" "103" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01DSP-MIDAS" "RX" "1" "23" "26" " " "DSP-MIDAS"
            RETURNING RESU.
       CALL "SD_Init" USING 
            "02DSP-MIDAS" "X" "5" "27" "4" "01DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "03DSP-MIDAS" "X" "5" "37" "4" "02DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "04DSP-MIDAS" "X" "7" "15" "8" "03DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "05DSP-MIDAS" "X" "7" "27" "1" "04DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "06DSP-MIDAS" "X" "7" "30" "1" "05DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "07DSP-MIDAS" "X" "9" "15" "4" "06DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "08DSP-MIDAS" "X" "9" "27" "1" "07DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "09DSP-MIDAS" "X" "9" "30" "1" "08DSP-MIDAS" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *DSP-CLR
       ...
       CALL "SD_Init" USING 
            "01DSP-CLR" "X" "7" "25" "2" " " "DSP-CLR" RETURNING RESU.
       CALL "SD_Init" USING 
            "02DSP-CLR" "X" "7" "28" "2" "01DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "03DSP-CLR" "X" "7" "31" "2" "02DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "04DSP-CLR" "X" "7" "36" "6" "03DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "05DSP-CLR" "X" "9" "25" "2" "04DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "06DSP-CLR" "X" "9" "28" "2" "05DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "07DSP-CLR" "X" "9" "31" "2" "06DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "08DSP-CLR" "X" "9" "36" "6" "07DSP-CLR" " " RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *///////////////
           ...
           IF  JMST1-06  >  GMN-TYMD
               GO  TO  READ-RTN
           END-IF
           IF  JMST1-03  <  GMN-FHCD
               GO  TO  READ-RTN
           END-IF
           IF  JMST1-03  >  GMN-THCD
               GO  TO  READ-RTN
           END-IF
      **
