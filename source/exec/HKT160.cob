      ...
      *C-DSP
       ...
       CALL "SD_Init" USING 
            "D-SS" " " "3" "53" "7" " " "D-SHJ"  RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "D-SHC" " " "3" "53" "12" "D-SSI" " "  RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "D-SG" " " "3" "53" "14" "D-SHC" " "  RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_From" USING 
            "03D-SG" BY REFERENCE WR-SGR "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "04D-SG" "X" "3" "54" "1" "03D-SG" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "D-ST" " " "3" "53" "14" "D-SG" " "  RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "D-SKR" " " "3" "53" "10" "D-ST" " "  RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "05C-DSP" " " "W-L" "0" "81" "D-SHJ" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "D-DATA" " " "W-L" "53" "73" " " "05C-DSP" RETURNING RESU.
       CALL "SD_Init" USING 
            "01D-DATA" "Z9" "W-L" "1" "2" " " "D-DATA" RETURNING RESU.
       CALL "SD_From" USING 
            "01D-DATA" BY REFERENCE TUK-GET "2" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "02D-DATA" "Z9" "W-L" "3" "2" "01D-DATA" " " RETURNING RESU.
       CALL "SD_From" USING 
            "02D-DATA" BY REFERENCE TUK-PEY "2" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "03D-DATA" "X" "W-L" "6" "6" "02D-DATA" " " RETURNING RESU.
       CALL "SD_From" USING 
            "03D-DATA" BY REFERENCE W-DNO "6" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "04D-DATA" "X" "W-L" "12" "1" "03D-DATA" " " RETURNING RESU.
       CALL "SD_From" USING 
       ...
       CALL "SD_Init" USING 
            "D-WNK" " " "23" "53" "18" "D-WNKC" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "01D-WNK" "X" "23" "16" "1" " " "D-WNK"  RETURNING RESU.
       CALL "SD_Init" USING 
            "02D-WNK" "N" "23" "17" "12" "01D-WNK" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "03D-WNK" "X" "23" "34" "1" "02D-WNK" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "04D-WNK" "X" "23" "39" "1" "03D-WNK" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "05D-WNK" "X" "23" "44" "1" "04D-WNK" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "06D-WNK" "X" "23" "49" "1" "05D-WNK" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "07D-WNK" "X" "23" "54" "1" "06D-WNK" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "D-WTCD1" "9" "23" "30" "4" "D-WNK" " "  RETURNING RESU.
       CALL "SD_From" USING 
            "D-WTCD1" BY REFERENCE W-WTCD1 "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-WTCD2" "9" "23" "35" "4" "D-WTCD1" " "  RETURNING RESU.
       CALL "SD_From" USING 
            "D-WTCD2" BY REFERENCE W-WTCD2 "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-WTCD3" "9" "23" "40" "4" "D-WTCD2" " "  RETURNING RESU.
       CALL "SD_From" USING 
            "D-WTCD3" BY REFERENCE W-WTCD3 "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-WTCD4" "9" "23" "45" "4" "D-WTCD3" " "  RETURNING RESU.
       CALL "SD_From" USING 
            "D-WTCD4" BY REFERENCE W-WTCD4 "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "D-WTCD5" "9" "23" "50" "4" "D-WTCD4" " "  RETURNING RESU.
       CALL "SD_From" USING 
      ...
      *///////////////
           CALL "DB_Read" USING
            "INVALID" TT-M_PNAME1 BY REFERENCE TT-R "UNLOCK"
            RETURNING RET.
           IF  RET = 1
               GO TO S-35
           END-IF
