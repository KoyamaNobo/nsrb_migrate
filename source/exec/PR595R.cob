      ...
      *       01  ACP-AREA.
       ...
       CALL "SD_Init" USING 
            "ACP-W02" "9" "4" "11" "4" "ACP-W01T" " "  RETURNING RESU.
       CALL "SD_Using" USING 
            "ACP-W02" BY REFERENCE W-02 "4" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "ACP-W03" "9" "23" "2" "2" "ACP-W02" " "  RETURNING RESU.
       CALL "SD_Using" USING 
      ...
      *    01  DSP-ITEM-AREA
       ...
       CALL "SD_From" USING 
            ...
            BY REFERENCE I 125 RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *    01  DSP-AREA1
       ...
       CALL "SD_From" USING 
            ...
            BY REFERENCE W-03 125 RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *///////////////
       ...
       MR999.
           ...
           STOP RUN.
       INI-RTN.
           CALL "SD_Screen_Output" USING "GR5950" RETURNING RESU.
           MOVE 0     TO ERR-SW.
      ...
      *///////////////
       ...
       W02-RTN.
           CALL "SD_Accept" USING
            BY REFERENCE ACP-W02 "ACP-W02" "9" "4"
            BY REFERENCE ESTAT RETURNING RESU.
           CALL "SD_Output" USING
            "DISP-MSG-SPACE" DISP-MSG-SPACE "p" RETURNING RESU.
           IF  ESTAT = "P9"
      ...
      *///////////////
       ...
       ZAN-SET-RTN.
           ...
           MOVE FI     TO I.
       ZAN-SET-000.
           ADD KZM-TJKR(I)     TO W-KARI.
           ADD KZM-TJKS(I)     TO W-KASI.
           IF  I = TI
               GO TO ZAN-SET-900
           END-IF.
           IF  I = 12
