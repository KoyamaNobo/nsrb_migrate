       ...
       AUTHOR.                        E-SHIGIHARA.
      ***************************************************
      *    PROGRAM        : ïiñºéÛíçì˙ï Å@éÛíçécÉäÉXÉg  *
      *    DATA WRITTEN   : 99/ 9/ 3                    *
      *    SCREEN USED    : UNUSED                      *
      *    FORM   USED    : UNUSED                      *
      *    PRINTER TYPE   : JIPS                        *
      ...
      ***************************************************
       ...
       01  HEAD2.
           ...
           02  FILLER                PIC N(06)  VALUE  "ïiÅ@Å@Å@Å@ñº".
           02  FILLER                PIC X(120)  VALUE  SPACE.
       01  HEAD3.
           ...
           02  FILLER                PIC X(096)  VALUE  SPACE.
       01  HEAD4.
           02  FILLER                PIC X(43)  VALUE  SPACE.
       ...
       01  DSP-AREA.
           02  DSP-01.
               03  FILLER  PIC  X(28)
                               VALUE  "                            ".
               03  FILLER  PIC  X(26)
                               VALUE  "ïiñºéÛíçì˙ï Å@éÛíçécÉäÉXÉg".
           02  DSP-07.
      ...
      *DSP-AREA
       ...
       CALL "SD_Init" USING
            "02DSP-01" "X" "1" "24" "26" "01DSP-01" " " RETURNING RESU.
       CALL "SD_Init" USING
      ...
      *//////////////////////
           ...
           IF (JWNOK-03  NOT  =   OLD-2)  OR  (CNT  = 0)
               PERFORM  TOT-RTN  THRU   TOT-EX
               PERFORM     GP1-RTN     THRU     GP1-EX
               PERFORM     GP2-RTN     THRU     GP2-EX
               MOVE     1   TO   CNT-M
      ...
      *********************************************
       INT-RTN.
           ...
           CALL "DB_F_Open" USING
            "OUTPUT" JWNOK_PNAME1 "SHARED" BY REFERENCE JWNOK_IDLST "0".
           CALL "DB_F_Open" USING
      ...
      *SHM-RTN.
       HIM-RTN.
           ...
           MOVE   K-1      TO  R1-K1.
           MOVE   K-2      TO  R1-K2.
           MOVE   OLD-2    TO    HI-MHCD HI-HCD  R1-02.
      ...
      ***************************************************
       TCM-RTN.
           ...
           IF  W-NDC           =   0
               MOVE  1         TO  W-NDC
               MOVE  OLD-1S    TO  R3-00
           END-IF
           MOVE   OLD-3    TO    TC-TCD   R3-01.
           MOVE   001      TO  TC-CCD.
      ...
      ***************************************************
       ...
       MOV-050.
           ...
           MOVE   JWNOK-03   TO  OLD-2.
           MOVE   JWNOK-021  TO  OLD-3
           MOVE   W-KEY      TO  OLD-4
           MOVE     1        TO   CNT.
           ADD      1        TO   N.
           MOVE     SW1   TO   O-SW1.
