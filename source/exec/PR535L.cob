      ...
      *
       ...
       01  BU-F_PR535L.
           ...
           02  F                PIC  X(001).
           02  BU-F_LNAME       PIC  X(011)  VALUE "BU-F_PR535L".
           02  F                PIC  X(001).
      ...
      *    01  DSP-AREA
       ...
       CALL "SD_Init" USING
            "DSP-CLR" "X" "0" "0" "11" " " "DSP-AREA"  RETURNING RESU.
       CALL "SD_Init" USING
      ...
      *
       MAIN-000.
           CALL "DB_F_Open" USING
            "INPUT" BUGEN-F_PNAME1 "SHARED" BY REFERENCE 
      ...
      *///////////////
           ...
           IF  RET = 1
               ...
               CALL "SD_Output" USING
                "DSP-014" DSP-013 "p" RETURNING RESU
               CALL "SD_Output" USING
                "DISP-BUZ-J-03" DISP-BUZ-J-03 "p" RETURNING RESU
               PERFORM   CHK-RTN   THRU   CHK-RTNEX
               GO  TO   END-99
      ...
      *///////////////
           ...
           IF  BU1URKBN NOT = "U"
               GO TO BUFG-010
           END-IF.
           COMPUTE WK-TOGET = WK-TOGET + BU1TOGET.
           COMPUTE WK-DOGET = WK-DOGET + BU1DOGET.
           GO TO BUFG-010.
       BUFG-EX.
           EXIT.
       COPY  LPMSG_PR.
