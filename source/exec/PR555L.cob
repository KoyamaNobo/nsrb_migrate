       ...
       INIT-RTN                    SECTION.
         INIT-000.
           ...
           CALL "DB_F_Open" USING
            "INPUT" BGNPRN_PNAME1 " " BY REFERENCE BGNPRN_IDLST "1"
      ...
      *///////////////
       ...
       BUPL-READ-RTN               SECTION.
         BUPL-READ-000.
      *           READ    BUGEN-F    UNLOCK   AT  END
      *//////////////////////
           CALL "DB_Read" USING
            "AT END" BUGEN-F_PNAME1 BY REFERENCE BU-REC "UNLOCK"
            RETURNING RET.
           IF  RET = 1
               MOVE    2      TO   SYORI-FLG
       ...
       ERR-RTN                 SECTION.
         ERR-000.
           CALL "SD_Output" USING "DSP-010" DSP-010 "p"
                                         RETURNING RESU.
           CALL "SD_Output" USING "DISP-BUZ-J-05" DISP-BUZ-J-05 "p"
                                                     RETURNING RESU.
