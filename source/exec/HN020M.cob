      ...
      *GAM-ACP
       ...
       CALL "SD_Using" USING 
            "ACP-05" BY REFERENCE W-05(1) "4" "1" BY REFERENCE TCNT 4
            RETURNING RESU.
      *PRN-ACP
       CALL "SD_Init" USING 
      ...
      *DSP-DSP
       CALL "SD_Init" USING 
            "DSP-DSP" " " "0" "0" "171" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01DSP-DSP" "N" "1" "1" "10" " " "DSP-DSP" RETURNING RESU.
       CALL "SD_Init" USING 
            "02DSP-DSP" "N" "1" "11" "36" "01DSP-DSP" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "03DSP-DSP" "N" "1" "47" "22" "02DSP-DSP" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "04DSP-DSP" "X" "3" "17" "36" "03DSP-DSP" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "05DSP-DSP" "X" "4" "17" "46" "04DSP-DSP" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
            "06DSP-DSP" "X" "23" "22" "21" "05DSP-DSP" " "
            RETURNING RESU.
      *DSP-PRN
       CALL "SD_Init" USING 
            "DSP-PRN" " " "0" "0" "91" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *DSP-CPY
       CALL "SD_Init" USING 
            "DSP-CPY" " " "0" "0" "43" " " " " RETURNING RESU.
       CALL "SD_Init" USING 
            "01DSP-CPY" "X" "5" "0" "11" " " "DSP-CPY" RETURNING RESU.
       CALL "SD_Init" USING 
            "02DSP-CPY" "X" "6" "8" "14" "01DSP-CPY" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "03DSP-CPY" "X" "8" "35" "2" "02DSP-CPY" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "04DSP-CPY" "X" "9" "35" "2" "03DSP-CPY" " " RETURNING RESU.
       CALL "SD_Init" USING 
            "05DSP-CPY" "X" "11" "8" "14" "04DSP-CPY" " "
            RETURNING RESU.
      *DSP-ERR
       CALL "SD_Init" USING 
      ...
      *///////////////
       ...
       ENT-026.
           IF  HI-MHCD NOT = HI-HCD
               ...
               CALL "SD_Output" USING "ERR-99" ERR-99 "p" RETURNING RESU
           END-IF
      *           READ  HI-M  NEXT RECORD UNLOCK  AT END
      *///////////////
           CALL "DB_Read" USING
      ...
      *****   使用サイズ　チェック  *****
           ...
           END-IF
           IF  W-BITT    =  "01111"
               CALL "SD_Output" USING "ERR-3" ERR-3 "p" RETURNING RESU
               IF  ACT   =   6 OR 7 OR 8
                   GO  TO  ENT-25
               ELSE
                   GO  TO  ENT-30
