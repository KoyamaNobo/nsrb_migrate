      ...
      *FD  HAIKI
       01  HAIKI_HKY910.
           02  HAIKI_PNAME1   PIC  X(006) VALUE "HAIK-K".
           02  F              PIC  X(001).
           02  HAIKI_LNAME    PIC  X(012) VALUE "HAIKI_HKY910".
           02  F              PIC  X(001).
       ...
       01  HAIK-R.
           02  HAIK-HCD       PIC  X(005).
           02  HAIK-SU        PIC  9(006)V9(02).
           02  F              PIC  X(008).
       77  F                  PIC  X(001).
      *
       77  ESTAT              PIC  X(002).
      ...
      *//////////////////////     
           CALL "DB_Read" USING
            "AT END" HAIKI_PNAME1 BY REFERENCE HAIK-R " " RETURNING RET.
           IF  RET = 1
               GO TO M-90
           END-IF
           IF  HAIK-SU = ZERO
