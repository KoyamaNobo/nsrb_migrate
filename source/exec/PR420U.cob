      ...
      *DISP-INIT
       ...
       CALL "SD_Init" USING 
            "0501DISP-INIT" "RX" "1" "31" "20" "0401DISP-INIT" " "
            RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *DISP-BUZZER
       ...
       CALL "SD_Init" USING
            ...
            RETURNING RESU.
       CALL "SD_Init" USING
            "DISP-BUZ-J-05" "X" "24" "80" "5" "DISP-BUZ-J-02" " "
            RETURNING RESU.
       CALL "SD_Init" USING
            "DISP-BUZ-J-09" "X" "24" "80" "5" "DISP-BUZ-J-05" " "
            RETURNING RESU.
      *DSP-AREA
       CALL "SD_Init" USING
       ...
       CALL "SD_From" USING
            "DSP-015" BY REFERENCE PLKEY(1) "3" "0"
      ...
      *
       ...
       ST-01.
           CALL "SD_Accept" USING
                 BY REFERENCE ACP-021 "ACP-021" "X" "1"
