      ...
      *>       USER     NAME.....                                <*
      *>       PROGRAM  NAME..... PR455L                         <*
      *>       PROGRAM  TITLE.... ﾌﾞﾓﾝﾍﾞﾂ  ｿﾝｴｷｹｲｻﾝｼｮ (ｹﾞﾂｼﾞ)    <*
      *>       AUTHOR   .........                                <*
      *>       DATE     WRITTEN..                                <*
      *>                                                         <*
      *>=========================================================<*
      ...
      ******************************************************
       ...
       01  WK-AREA.
           ...
           02  HIZUKE.
               ...
               03  WK-DD      PIC  9(02).
           02  SYUKEI.
               03  WK-TOGET   PIC  S9(11).
               03  WK-DOGET   PIC  S9(11).
      ...
      *
       ...
       01  DSP-AREA.
           ...
           03  DSP-010.
               05  DSP-011      PIC  X(14)  VALUE  "ｺﾝﾄﾛｰﾙ DATE ﾅｼ".
               05  DSP-012      PIC  X(13)  VALUE  "ｺﾝﾄﾛｰﾙ SEL ﾅｼ".
               05  DSP-013      PIC  X(33)  VALUE
                                "ﾌﾞﾓﾝﾍﾞﾂ ｿﾝｴｷ ﾌｧｲﾙ START ｴﾗｰ KEY= ".
               05  DSP-014      PIC  9(04).
      ...
      *DSP-AREA
       ...
       CALL "SD_Init" USING
            "DSP-CLR" "X" "24" "0" "11" " " "DSP-AREA"
            RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-010" " " "24" "0" "64" "DSP-CLR" " "  RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-011" "X" "23" "1" "14" " " "DSP-010"  RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-012" "X" "23" "1" "13" "DSP-011" " "  RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-013" "X" "23" "1" "33" "DSP-012" " "  RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-014" "9" "23" "35" "4" "DSP-013" " "  RETURNING RESU.
       CALL "SD_From" USING
      ...
      *///////////////
       ...
       MAIN-030.
           ...
           IF  BU-URKBN    NOT    =    "U"
               GO    TO    MAIN-020
           END-IF.
           COMPUTE    WK-TOGET    =    WK-TOGET    +    BU-TOGET.
           COMPUTE    WK-DOGET    =    WK-DOGET    +    BU-DOGET.
           GO    TO    MAIN-020.
       MAIN-040.
           IF  BU-BUMN   =    WK-BUMN
               GO   TO    MAIN-055
      ...
      *========<  ｺｳｾｲﾋ AND ﾋﾘﾂ  ｹｲｻﾝ  >==============*
           ...
           IF  WK-TOGET    =    0
               MOVE    0    TO    WK-KOSEI
           ELSE
               COMPUTE   WK-KOSEI   =   BU-TOGET   /   WK-TOGET
               COMPUTE   P-KOHI1    =   WK-KOSEI   *   100  +  0.005
           END-IF.
       MAIN-060.
           MOVE    BU-TOGET    TO    P-KIN1.
       MAIN-070.
           IF  BU-GOKBN    =    1
