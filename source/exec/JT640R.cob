       ...
       AUTHOR.                        MAYUMI.I.
      ***************************************************
      *    PROGRAM        : ìæà”êÊï èoâ◊é¿ê—ñ‚çáÇπÅ@Å@Å@* Å@Å@Å@
           ...
           02  CLR-01.
               ...
               03  CLR-02.
                   ...
                   04  CLR-03.
                       ...
                       05  FILLER  PIC X(04)   VALUE " ".
                       05  FILLER  PIC X(04)   VALUE " ".
                   04  FILLER  PIC  X(11) VALUE "CLEAR  DATA".
      ...
      *CLR-AREA
       ...
       CALL "SD_Init" USING
            "CLR-03" " " "20" "68" "40" "05CLR-02" " " RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_Init" USING
            "CLEAR" "X" "21" "68" "11" "CLR-03" " "  RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_Init" USING
            "CLR-SHOSAI" " " "0" "0" "100" "CLR-01" " " RETURNING RESU.
       CALL "SD_Init" USING
            "CLR-04" " " "20" "15" "40" " " "CLR-SHOSAI" RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_Init" USING
            "CLR-05" " " "21" "15" "60" "CLR-04" " "  RETURNING RESU.
       CALL "SD_Init" USING
      ...
      *DSP-AREA
       ...
       CALL "SD_From" USING
            "DSP-DEN" BY REFERENCE W-DEN "4" "0" RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-HCD" "9" "LIN" "13" "4" "DSP-DEN" " " RETURNING RESU.
       CALL "SD_From" USING
            "DSP-HCD" BY REFERENCE HI-HCD1 "4" "0" RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-HIN" "N" "LIN" "18" "48" "DSP-HCD" " " RETURNING RESU.
       CALL "SD_From" USING
            "DSP-HIN" BY REFERENCE HI-NAME "48" "0" RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-SOK" "---,--9" "LIN" "67" "7" "DSP-HIN" " "
            RETURNING RESU.
       CALL "SD_From" USING
      ...
      *DSP-AREA1
       CALL "SD_Init" USING
            "DSP-AREA1" " " "0" "0" "335" " " " "  RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-TOK" "N" "1" "20" "42" " " "DSP-AREA1" RETURNING RESU.
       CALL "SD_From" USING
            "DSP-TOK" BY REFERENCE TC-NAME "52" "0" RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-SHOSAI" " " "0" "0" "133" "DSP-TOK" " " RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-SHOSAI1" " " "0" "20" "127" " " "DSP-SHOSAI"
            RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_From" USING
            ...
            GG 133 RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-GNO" " " "0" "0" "7" "DSP-SIZE1" " "  RETURNING RESU.
       CALL "SD_Init" USING
       ...
       CALL "SD_From" USING
            ...
            BY REFERENCE GG 133 RETURNING RESU.
       CALL "SD_Init" USING
            "DSP-SHOSAI2" " " "0" "20" "6" "DSP-SHOSAI1" " "
            RETURNING RESU.
       CALL "SD_Init" USING
