      ...
      *FD  HTI-M
       01  HTI-M_HMN115.
           02  HTI-M_PNAME1   PIC  X(005) VALUE "HTIMW".
           02  F              PIC  X(001).
           02  HTI-M_LNAME    PIC  X(012) VALUE "HTI-M_HMN115".
           02  F              PIC  X(001).
      ...
      *C-ACP
       ...
       CALL "SD_Init" USING 
            "02C-ACP" " " "3" "0" "13" "A-ACT" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "A-SNO" "9" "3" "2" "1" " " "02C-ACP"  RETURNING RESU.
       CALL "SD_Using" USING 
       ...
       CALL "SD_Init" USING 
            "A-SU" "S9" "W-L" "W-C" "5" "02C-ACP" " "  RETURNING RESU.
       CALL "SD_Using" USING 
       ...
       CALL "SD_Init" USING 
            "05C-ACP" " " "15" "0" "12" "A-PC" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "A-SDNO" "X" "15" "29" "6" " " "05C-ACP"  RETURNING RESU.
       CALL "SD_Using" USING 
       ...
       CALL "SD_Init" USING 
            "A-DMM" "9" "23" "57" "1" "05C-ACP" " "  RETURNING RESU.
       CALL "SD_Using" USING 
            "A-DMM" BY REFERENCE W-DMM "1" "0" RETURNING RESU.
      *C-DSP
       CALL "SD_Init" USING 
            "C-DSP" " " "0" "0" "116" " " " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "D-WCM" "RN" "1" "70" "8" " " "C-DSP"  RETURNING RESU.
       CALL "SD_Init" USING 
            "02C-DSP" " " "3" "0" "60" "D-WCM" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "D-SN" "N" "3" "4" "12" " " "02C-DSP"  RETURNING RESU.
       CALL "SD_From" USING 
       ...
       CALL "SD_Init" USING 
            "D-ISU" "ZZ9" "4" "76" "3" "02C-DSP" " "  RETURNING RESU.
       CALL "SD_From" USING 
            "D-ISU" BY REFERENCE HI-ISU "3" "0" RETURNING RESU.
       CALL "SD_Init" USING 
            "04C-DSP" " " "W-L" "0" "12" "D-ISU" " "  RETURNING RESU.
       CALL "SD_Init" USING 
           "D-SU" "ZZZZ9-" "W-L" "W-C" "6" " " "04C-DSP" RETURNING RESU.
       CALL "SD_From" USING 
       ...
       CALL "SD_Init" USING 
            "D-SUG" " " "0" "0" "33" "04C-DSP" " "  RETURNING RESU.
       CALL "SD_Init" USING 
            "D-KT" " " "0" "70" "15" " " "D-SUG"  RETURNING RESU.
       CALL "SD_Init" USING 
       ...
       CALL "SD_Init" USING 
            "D-AT" " " "0" "70" "18" "D-KT" " "  RETURNING RESU.
       CALL "SD_Init" USING 
      ...
      *
       ...
       M-040.
           ...
           CALL "SD_Output" USING "D-WCM" D-WCM "p" RETURNING RESU.
           IF  W-ACT NOT = 0
      ...
      *///////////////
           CALL "DB_Read" USING
            "INVALID KEY" HTI-M_PNAME1 BY REFERENCE HTI-R "UNLOCK"
            RETURNING RET.
           IF  RET = 1
               GO TO M-600
           END-IF
